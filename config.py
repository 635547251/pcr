...
# 需要爬取的角色
ch_whitelist = [
    "羊驼", "布丁", "空花", "黑骑", "狗拳", "佩可", "望", "狼", "裁缝", "猫剑", "水吃", "铃铛", "姐姐", "兔兔", "黄骑", "毛二力", "扇子", "yly", "充电宝", "中二", "妈", "水妈", "深月", "妹法", "姐法", "yls", "妹弓", "暴击弓", "tp弓", "老师", "圣母", "黑猫", "初音", "大眼", "真步", "镜子", "xcw"
]

ch_blacklsit = [
    "猫拳", "熊锤", "吉他", "剑圣", "奶牛", "子龙", "松鼠", "女仆", "香菜弓", "千歌", "病娇", "忍", "ue", "哈哈剑", "炸弹人"
]
